...
class PatientService:
    ...
    def get_patient_detail(self, request: GetPatientRequest) -> PatientDetailResponse:
        ...
        # Get all medical records for this patient (most recent first)
        medical_records = self.medical_data_repository.find_by_patient_id(request.patient_id)

        # Build response with medical records
        patient_dict = patient.to_dict()
        patient_dict['medical_records'] = [record.to_dict() for record in medical_records]
